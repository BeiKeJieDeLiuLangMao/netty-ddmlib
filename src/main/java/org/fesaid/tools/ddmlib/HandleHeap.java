...
import org.fesaid.tools.ddmlib.ClientData.AllocationTrackingStatus;
import org.fesaid.tools.ddmlib.ClientData.IHprofDumpHandler;
...
final class HandleHeap extends ChunkHandler {
    ...
    public void handleChunk(Client client, int type, ByteBuffer data, boolean isReply, int msgId) {
        Log.d("ddm-heap", "handling " + name(type));
