...
import org.fesaid.tools.ddmlib.ClientData.IMethodProfilingHandler;
import org.fesaid.tools.ddmlib.ClientData.MethodProfilingStatus;
...
final class HandleProfiling extends ChunkHandler {
    ...
    public void handleChunk(Client client, int type, ByteBuffer data,
        ...
        Log.d("ddm-prof", "handling " + name(type));
